...
CoralTraits::Application.routes.draw do
  ...
  # get '/species/:species_id/traits/:id', to: 'traits#show', :as => :specie_trait
...
# get '/meta/:ids', to: 'static_pages#show'
  ...
  get '/release',        to: 'static_pages#release'
  get '/uploads',        to: 'static_pages#uploads'

  get '/procedures',  to: 'static_pages#procedures'
  get '/editors',     to: 'static_pages#editors'
  get '/contributors', to: 'static_pages#contributors'
  get '/download',    to: 'static_pages#download'
  get '/bulk_import', to: 'static_pages#bulk_import'
  get '/documentation',    to: 'static_pages#documentation'

  get '/doi_new',    to: 'resources#doi_new'
